...
set @locationId:= 11;
SELECT 
   'Number of clients Started  Cryptococcal Treatment 12 mons ago and have  CD4 Test done at month 12' as 'Indicator',
    b.clinic,
    b.location_id,
...
FROM
    ...
    WHERE
        m.on_art_this_month = 1
            ...
            AND TIMESTAMPDIFF(MONTH, c.cryptococcal_tx_start_date, fhs.cd4_1_date) = 12
